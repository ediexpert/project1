...
<head>
    ...
    <title>Stockholm Flight Academy</title>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="home"><img class="img-responsive" src="logo/logo.png" alt="SFA" style="padding:5px; height:60px; margin-top:-20px;"></a>
            </div>
...
<ul class="nav navbar-nav navbar-right">
    ...
    <li class="page-scroll">
         <a href=""><?php echo get_username($_SESSION['id']);?></a>
    </li>
    <li class="page-scroll">
