        ...
        <div class="container">
            ...
            <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="page-scroll">
                         <a href="<?php echo base_url();?>index.php/testing/users">USERS</a>
                    </li>
                    <li class="page-scroll">
                         <a href="<?php echo base_url();?>index.php/testing/tests">TESTS</a>
                    </li>
                    <li class="page-scroll">
                         <a href="<?php echo base_url();?>index.php/testing/results">RESULTS</a>
                    </li>
