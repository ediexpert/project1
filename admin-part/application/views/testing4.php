            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="intro-text">
                        <h3>Congratulations! Your Test is submitted Successfully. Now Lets Start Next Category Test</h3>
                        <h4>Next Category Test Rules &amp; Regulations</h4>
                        <div class="text-left">
                        <p>1. During the Test Please do not refresh the page 
                            and Do not toggle from one tab to another as this may result to Failure of Test and Disqualification.
                        </p>
                        <p>2. During the Test Please do not refresh the page 
                            and Do not toggle from one tab to another as this may result to Failure of Test and Disqualification.
                        </p>
                        <p>3. During the Test Please do not refresh the page 
                            and Do not toggle from one tab to another as this may result to Failure of Test and Disqualification.
                        </p>
                        </div>
                            
                        <form action="<?php echo base_url();?>index.php/testing/access_test" method="POST">
                            
                            <fieldset>
                                <input type="checkbox" required="" />
                                <label>
                                    I Agree Test Term &amp; Conditions.
                                </label>
                               

                            </fieldset>
                            <fieldset>
                                <input type="submit" value="Start Test" class="btn btn-primary btn-lg"> 
                            </fieldset>
