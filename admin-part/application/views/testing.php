...
<body id="page-top" class="index">
    ...
    <header>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <img class="img-responsive" src="<?php echo base_url();?>logo/logo.png" alt="">
                    <div class="intro-text">
                        <span class="name">SFA PILOT COMPASS TEST</span>
                        <hr class="star-light">
                        <span class="skills">Welcome to SFA Pilot Compass Test</span><hr>
                        <form action="<?php echo base_url();?>index.php/testing/conditions" method="POST">
                            <input type="submit" class="btn btn-primary btn-lg btn-block" value="Start Test">
                        </form>
                    </div>
                </div>
            </div>
