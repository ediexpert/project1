                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
								...
								<td data-th="First Name"><?php echo $row->first_name;?>&nbsp;<?php echo $row->last_name;?></td>
								<td  data-th="Password"><?php echo $row->pass;?></td>
								<td  data-th="Email"><?php echo $row->email;?></td>
                                <td  data-th="Notes"><?php echo $row->note;?></td>
								<td  data-th="Action">
                                    <?php /*<a href="<?php echo site_url('user_data/delete_user/'.$row->id );?>">Remove</a>*/?>
                                    <?php $x = rand ( 10 , 99 ); $xx = 2*$x;?>
                                    <a href="javascript: var x= prompt('Warning!! You are going to delete a USER PERMANENTLY from your System. Please Confirm.<?php echo "{$x}+{$x}=";?>'); if(x == <?php echo $xx;?>){ window.location='<?php echo site_url('user_data/remove_user/'.$row->id );?>'; }else{alert('wrong answer')}" class="btn btn-danger btn-xs">Remove</a> 								<a href="<?php echo site_url('user_data/edit_user/'.$row->id );?>" class="btn btn-info btn-xs">Edit</a>
