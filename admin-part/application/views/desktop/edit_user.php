                                ...
                                <div class="col-lg-6">
                                  <form method="post" action="<?php echo site_url('user_data/update_user/'.$user_id);?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="user_password" value="<?php echo $user['pass']; ?>" autocomplete="off">
										 </div>
                                    
                                        <div class="form-group">
                                            <label>Confirm Password (Optional)</label>
                                            <input class="form-control" type="text" name="confirm_password"   value="<?php echo $user['pass']; ?>" autocomplete="off">
										 </div>
